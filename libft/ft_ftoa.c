...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/18 18:56:09 by Xecca             #+#    #+#             */
/*   Updated: 2019/11/18 19:03:52 by Xecca            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*ft_ftoa_long(long double nbr, unsigned int precision)
{
	...
	ft_strjoin_free(ft_straddchar(ft_itoa_unsigned(whole), ch), fract, 1), 2)\
	: ft_strjoin_free(ft_straddchar(ft_itoa_unsigned(whole), ch), fract, 1);
}
